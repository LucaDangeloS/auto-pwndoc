...
- Vulnerability auto-translation is best-effort per related target. Successful target languages are updated and marked `pending-review`; failed targets are marked `failed` and reported in the route response without aborting the rest of the translation group.
