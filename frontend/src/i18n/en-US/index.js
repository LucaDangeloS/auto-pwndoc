export default {
    ...
    msg: {
        ...
        taxonomyItemsHelp: 'Manage individual taxonomy entries. Type is required; category and subcategory are optional. Sort configuration only applies to type-root rows (no category and no subcategory).',
        taxonomyBulkHelp: 'Paste/edit one entry per line. Format: Type [> Category [> Subcategory]] [CODE]. Lines starting with # are comments. Click "Preview changes" to see additions and removals before applying.',
