export default {
    ...
    apiKeysDescription: 'API keys grant programmatic access to the autopwndoc REST API. They can be used in the X-API-Key header or as a Bearer token in the Authorization header.',
    apiKeyName: 'Key name',
    apiKeyNameHint: 'A short label to identify this key (e.g. "CI pipeline", "External MCP")',
    ...
    chartThemeDescription: 'Configure the editable 3D severity pie chart used by report templates.',
    ...
    importCvssHint: 'CVSS scores are not imported automatically — set the CVSS vector on each finding after import.',
    btn: {
        accept: 'Accept',
        cancel: 'Cancel',
        confirm: 'Confirm',
    ...
    msg: {
        ...
        confirmLanguageSwitchTitle: 'Switch to linked translation',
        confirmLanguageSwitchMessage: 'This language is stored in a linked translation. Switching will load that vulnerability and discard your unsaved changes here. Continue?',
        vulnerabilityRelationOk: 'Vulnerabilities related successfully',
        vulnerabilityUnrelatedOk: 'Vulnerability relation removed successfully',
        ...
        checklistBulkHelp: 'Use the taxonomy bulk format: Type > Category > Subcategory [CODE]. Fill/copy the selected methodology hierarchy, edit it if needed, then import it into the checklist rows.',
        ...
        checklistTemplateGuideIntro: 'For DOCX reports, create one Word table and add the divider row and item row once inside the checklist loop. Style the divider row dark in Word; docxtemplater repeats the right row automatically.',
    ...
    aiAuditContextHint: 'Optional context such as the assessment framework, target exposure, authentication coverage, environment, constraints, and assumptions. Used to ground AI-generated report content.',
    ...
    aiPromptSectionVulnerabilityTranslationCaption: 'Translates related vulnerability records between languages',
    ...
    aiVisionAnonymizeRegexHint: 'Apply ordered pattern-based redaction to the model output. This does not redact the images before they are sent to the vision provider.',
    aiVisionRegexRules: 'Anonymization regex rules',
    aiVisionRegexRulesHint: 'Rules run in order against the proof-analysis output before semantic search and PoC generation.',
    ...
    aiVisionRegexNoRules: 'No regex rules are configured. Regex anonymization will not redact anything.',
    aiVisionSystemPrompt: 'Vision / Proof Analysis System Prompt',
    aiVisionSystemPromptHint: 'Instructions used to analyze PoC text and screenshots. Reset to restore the built-in cybersecurity analyst prompt.',
    ...
    proofCompletionRunning: 'Analyzing proof, generating fields, and searching similar vulnerabilities…',
    proofCompletionStepAnalyze: 'Analyzing the proof text and images',
    proofCompletionStepGenerate: 'Generating title, description, observation, remediation, CVSS, and references',
    proofCompletionStepSearch: 'Searching the vulnerability library for similar entries',
    ...
    proofGeneratedCandidate: 'Generated from proof',
    proofGeneratedCandidateCaption: 'AI-generated field completion from the current proof evidence',
    ...
    graphSeverityPie3DUseCase: 'Shows the distribution of findings by severity. Optional parameters after the title set labels to value, percent, both, or none. Chart colors come from app settings.',
    graphSeverityPie3DNamed: '3D severity pie with title',
    graphSeverityPie3DNamedUseCase: 'Uses the same severity chart with a custom title in the generated report.',
    graphLegacySeverityPie: 'Classic severity pie',
    graphLegacySeverityPieUseCase: 'Renders a 2D severity pie chart with explicit colors for Critical, High, Medium, and Low findings.',
    graphFindingsByType: 'Bar chart by type',
    graphFindingsByTypeUseCase: 'Compares finding counts across the taxonomy or legacy categories. Optional final parameters set number labels to value, percent, both, or none. Chart colors come from app settings.',
    graphFindingsBySeverity: 'Bar chart by severity',
    graphFindingsBySeverityUseCase: 'Compares finding counts by CVSS severity. Optional final parameter sets number labels to value, percent, both, or none. Chart colors come from app settings.',
    ...
    untitled: '(untitled)',
    auditsArchive: 'Audits Archive',
    auditsArchiveDescription: 'Upload and read past audit reports as PDF files.',
    archiveUploadPdf: 'Upload PDF',
    archiveUploadHint: 'Only PDF files up to 200 MB are accepted.',
    ...
    mergeVulnerabilities: 'Relate Vulnerability Translations',
    mergeVulnerabilitiesInfo: 'Relate vulnerabilities that represent the same library issue in different languages. Existing records are kept; only the translation mapping changes.',
    relatedTranslations: 'Related translations',
    relatedTranslationsHint: 'Map this vulnerability to equivalent vulnerabilities in other languages. One vulnerability per language is allowed in each group.',
    noRelatedTranslations: 'No related translations yet.',
    relatedVulnerability: 'Related vulnerability',
    relateTranslation: 'Relate translation',
    unrelateTranslation: 'Unrelate translation',
    ...
    missingLanguageTranslationHint: 'Generate a new language version inside this vulnerability when no linked vulnerability exists.',
    ...
    matchingThresholdHint: 'Maximum embedding distance allowed for a match (0 = identical, higher = less similar). Lower values are stricter and only pair closer matches.',
    matchingProgress: 'Processed {processed} of {total}',
    startMatching: 'Start matching',
    applySelectedMappings: 'Apply selected mappings',
    vulnerabilityMatchingApplied: 'Applied {count} mapping(s), skipped {skipped}',
    ...
    cleanTranslationMappings: 'Clean translation mappings',
    translationCleanupDone: 'Cleaned {members} stale member(s), removed {groups} empty group(s), repaired {sources} source marker(s)',
    distance: 'Distance',
    aiVulnerabilityProcessing: 'Vulnerability processing',
    aiVulnerabilityProcessingDescription: 'Options for keeping library vulnerabilities synchronized across languages.',
    autoTranslateVulnerabilitiesOnSave: 'Auto-translate vulnerabilities on save',
    autoTranslateVulnerabilitiesTokenNote: 'This uses the main generative model to fill missing language versions and sync related vulnerabilities when a vulnerability is created or updated.',
