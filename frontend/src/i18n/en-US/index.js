export default {
    ...
    graphFindingsByTypeUseCase: 'Compares finding counts across the taxonomy or legacy categories. Optional final parameters set number labels to value, percent, both, or none, then set number color and title color. Bar colors always come from app severity settings.',
    graphFindingsBySeverity: 'Bar chart by severity',
    graphFindingsBySeverityUseCase: 'Compares finding counts by CVSS severity. Optional final parameters set number mode, number color, and title color.',
