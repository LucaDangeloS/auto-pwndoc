export default {
    ...
    apiKeyOwner: 'Owner',
    apiKeyOwnerMissing: 'Unassigned legacy key',
    apiKeyOwnerUnavailable: 'Owner account unavailable',
    apiKeyClaim: 'Assign to me',
    apiKeyClaimed: 'API key assigned to your user',
