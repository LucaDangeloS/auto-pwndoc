export default {
    ...
    graphSeverityPie3DUseCase: 'Shows the distribution of findings by severity using the configured CVSS version and report chart theme.',
    ...
    graphFindingsByTypeUseCase: 'Compares finding counts across the taxonomy or legacy categories.',
    graphFindingsBySeverity: 'Bar chart by severity',
    graphFindingsBySeverityUseCase: 'Compares finding counts by CVSS severity; optional parameters can tune bar color, label color, and label size.',
