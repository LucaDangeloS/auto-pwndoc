export default {
    ...
    chartTheme: '图表主题',
    chartThemeDescription: '配置报告模板使用的可编辑 3D 严重性饼图。',
    titleColor: '标题颜色',
    titleSize: '标题大小',
    titleBold: '标题加粗',
    legendColor: '图例颜色',
    legendSize: '图例大小',
    legendPosition: '图例位置',
    legendPositionRight: '右侧',
    legendPositionBottom: '底部',
    legendPositionTop: '顶部',
    legendPositionLeft: '左侧',
    legendPositionTopRight: '右上',
    dataLabelColor: '数据标签颜色',
    dataLabelSize: '数据标签大小',
    dataLabelBold: '数据标签加粗',
    dataLabelMode: '数据标签模式',
    dataLabelValue: '数值',
    dataLabelPercent: '百分比',
    dataLabelBoth: '数值和百分比',
    dataLabelNone: '无',
    borderEnabled: '启用边框',
    borderColor: '边框颜色',
    borderWidth: '边框宽度',
    plotAreaFill: '绘图区填充',
    plotAreaFillNone: '不填充',
    view3DRotX: '3D X 旋转',
    view3DRotY: '3D Y 旋转',
    view3DPerspective: '3D 透视',
    view3DRightAngleAxes: '直角坐标轴',
    nav: {
        audits: '项目审计',
        auditsArchive: '审计归档',
    ...
    msg: {
        ...
        typeRequired: '类型必填',
        taxonomyItemsHelp: '管理分类条目。类型必填；分类和子分类可选。排序配置仅适用于根类型行。',
        taxonomyBulkHelp: '每行一个条目。格式：类型 [> 分类 [> 子分类]] [代码]。以 # 开头的行为注释。',
        taxonomyEntryCreated: '分类条目已创建',
        taxonomyEntryUpdated: '分类条目已更新',
        taxonomyEntryDeleted: '分类条目已删除',
        deleteTaxonomyEntryConfirm: '删除条目 "{line}" ?',
        bulkHasErrors: '请先修复解析错误',
        bulkErrorsHeader: '解析错误',
        bulkErrorLine: '第 {line} 行',
        confirmTaxonomyReplace: '替换分类 ?',
        confirmTaxonomyReplaceMsg: '添加 {add}，删除 {remove}，保留 {keep}。这将替换整个集合。',
        taxonomyReplaced: '分类已替换',
        previewChanges: '预览',
        previewSummary: '{add} 项添加，{remove} 项删除，{keep} 项不变',
        toBeAdded: '将添加',
        toBeRemoved: '将删除',
        checklistSeedHelp: '每行一项。格式：标签，或 标签 | 类型 > 分类 > 子分类 [代码]，或 类型 > 分类 > 子分类 [代码]。# 开头为注释。',
        checklistEmpty: '清单为空 — 请在数据页种入条目。',
        checklistGenerated: '已生成 {count} 行清单',
        generateChecklistHelp: '选择分类类型和要包含的层级。该语言中已有的行将被替换。',
    },
    err: {
    ...
    items: '条目',
    bulkEdit: '批量编辑',
    bulkEditTextarea: '每行一个条目：类型 [> 分类 [> 子分类]] [代码]',
    checklist: '清单',
    checklistSeed: '清单条目',
    item: '项目',
    status: '状态',
    ...
    aiRegenerate: '重新生成',
    aiRegenerateTooltip: '丢弃此建议并再次请求 AI',
    aiAssistant: 'AI 助手',
    aiSuggest: 'AI 建议',
    aiSuggestTooltip: '基于审计上下文用 AI 生成此部分',
    aiSuggestOverwriteTitle: '是否覆盖已有内容？',
    aiRewriteWholeTitle: '未选择文本',
    aiRewriteWholeMessage: '没有选择任何文本。是否要重写整个字段？',
    aiGeneratingAction: 'AI 正在撰写…',
    aiCompletingAction: 'AI 正在续写…',
    aiRewritingAction: 'AI 正在重写…',
    aiEmptyResponse: 'AI 返回了空响应',
    aiInFlightTitle: 'AI 请求仍在进行中',
    aiInFlightMessage: '有 AI 请求仍在进行中。离开将取消此请求。是否继续？',
    aiDisabledReasonGlobal: 'AI 已禁用。请在 设置 → AI 中启用。',
    aiDisabledReasonEmbedding: '嵌入搜索已禁用。请在 设置 → AI → Embedding 中启用。',
    aiDisabledReasonVision: '视觉分析已禁用。请在 设置 → AI → Vision 中启用。',
    aiHideApiKey: '隐藏 API 密钥',
    aiShowApiKey: '显示 API 密钥',
    aiRefreshModels: '从提供者刷新模型列表',
    aiModelManualHint: '未找到模型 — 请手动输入模型 ID',
    aiTestLastRunAt: '上次测试：{time}',
    aiReindexConfirmTitle: '是否重新索引所有漏洞？',
    aiReindexConfirmMessage: '这将为每个漏洞调用一次 Embedding API。可能需要几分钟，并根据提供者产生 API 费用。',
    aiReindexAlreadyRunning: '重建索引已在进行中',
    aiReindexProgress: '重建索引中… {processed} / {total}',
    aiReindexFinished: '重建索引完成 — 已索引 {ok} 个漏洞',
    aiReindexFinishedWithFailures: '重建索引完成 — {ok} 成功，{failed} 失败',
    mcpClearKeyConfirmTitle: '是否清除 MCP 密钥？',
    mcpClearKeyConfirmMessage: '清除密钥将立即使所有使用它的 MCP 客户端失效。需要生成新密钥并重新配置客户端。是否继续？',
    mcpCopyKey: '复制密钥到剪贴板',
    similarVulnSearchTooltip: '通过语义搜索在目录中查找类似漏洞',
    searchSimilarFromProofsTooltip: '分析证据图像并搜索类似漏洞',
    similarVulnSelectAll: '全选',
    similarVulnSelectChanged: '仅已更改',
    similarVulnApplyHint: '至少勾选一个字段才能应用',
    similarVulnApplyCount: '已选择 {n} 个字段',
    similarVulnChanged: '已更改',
    similarVulnSame: '未更改',
    untitled: '(无标题)',
    auditsArchive: '审计归档',
    auditsArchiveDescription: '上传并阅读过往审计报告 PDF 文件。',
    archiveUploadPdf: '上传 PDF',
    archiveUploadHint: '仅接受最大 200 MB 的 PDF 文件。',
    archivePdfFile: 'PDF 文件',
    archivePdfRequired: '请选择 PDF 文件',
    archivePdfOnly: '只允许 PDF 文件',
    archivePdfTooLarge: 'PDF 文件超过 200 MB 限制',
    archiveUpload: '上传',
    archiveUploadOk: '归档审计上传成功',
    archiveNoReports: '暂无归档审计',
    archiveSelectReport: '选择一个归档审计进行阅读',
    archiveOutline: '报告目录',
    archiveNoOutline: '此 PDF 没有嵌入目录',
    archiveSearchInPdf: '在 PDF 中搜索',
    archiveSearchPlaceholder: '搜索报告文本',
    archiveSearchNoResults: '未找到匹配页面',
    archiveBuildingIndex: '正在建立可搜索索引…',
    archivePage: '页',
    archiveLoadingPdf: '正在加载 PDF…',
    archiveDeleteConfirm: '删除归档审计？',
    archiveDeleteOk: '归档审计删除成功',
    archiveError: '归档操作失败',
    saveSettings: '保存系统设置',
